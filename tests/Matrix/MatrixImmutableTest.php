...
use Guillaumetissier\Maths\Matrix\MatrixImmutable;
use PHPUnit\Framework\TestCase;

final class MatrixImmutableTest extends TestCase
{
    public function testConstructAndGetters(): void
    {
        ...
        $matrix = new MatrixImmutable($data);
    ...
    public function testInvalidConstruct(): void
    {
        ...
        $this->expectException(\InvalidArgumentException::class);
        new MatrixImmutable([[1.0, 2.0], [3.0]]);
    }

    public function testOutOfBounds(): void
    {
        $matrix = new MatrixImmutable([[1.0, 2.0], [3.0, 4.0]]);
    ...
    public function testTranspose(): void
    {
        ...
        $this->assertSame(3, $transposed->rows());
        $this->assertSame(2, $transposed->cols());
        $this->assertSame([1.0, 4.0], $transposed->row(0));
        $this->assertSame([2.0, 5.0], $transposed->row(1));
        $this->assertSame([3.0, 6.0], $transposed->row(2));
    }

    public function testAdd(): void
    {
        $a = new MatrixImmutable([
            [1.0, 2.0],
            [3.0, 4.0],
        ]);
        $b = new MatrixImmutable([
            [5.0, 6.0],
            [7.0, 8.0],
        ]);
    ...
    {
        $a = new MatrixImmutable([[1.0, 2.0]]);
        $b = new MatrixImmutable([[1.0, 2.0], [3.0, 4.0]]);
